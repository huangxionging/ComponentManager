...
+ (void)setViewController:(UIViewController *)controller backBarButtonItemImage:(NSString *)imageName {
    controller.navigationItem.leftBarButtonItem = [[UIBarButtonItem alloc] initWithImage: [UIImage imageNamed: @"web_back"] style:UIBarButtonItemStylePlain target: nil action: nil];
}
